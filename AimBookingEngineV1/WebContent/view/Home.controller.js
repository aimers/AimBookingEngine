...
sap.ui.controller("sap.ui.medApp.view.Home", {
  ...
  getAddressSuggestions : function() {
    ...
    this.oView.byId("multiInput2").setFilterFunction(function(sTerm, oItem) {
  ...
  handleSearchKeyword : function(evt) {
    ...
    if (sessionStorage.medAppUID) {
      ...
      medAppUID = "1";
      var addressBar = this.oView.byId("multiInput2");
    }
  ...
  getGeoLocation : function() {
    ...
    var _this = this;
    var display_user_location = function display_user_location(user_position) {
    ...
    if (geocoder) {
      geocoder.geocode({
        ...
        if (status == google.maps.GeocoderStatus.OK) {
          ...
          medApp.global.config.user.Address.LATIT = lat;
          medApp.global.config.user.Address.LONGT = log;
